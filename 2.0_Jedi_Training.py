...
#you put a hashtag/pound symbol in front of the line you want to make into a comment
...
b%a                 =1
a+B                 =7
type(42)            =<class 'int'> (or 42)
type(42.0)          =<class 'float'> (or 42.0)
type("C3PO")        =<class 'str'> (or 'C3PO')
type(True)          =Error Type name is not defined, input call is infalid. True = True
